    ...
    <div class="container tab-pane active">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3">
            ...
            <ul class="nav nav-pills nav-fill gap-2 p-1 large  rounded-5 shadow-sm" id="pillNav2" role="tablist" style="--bs-nav-link-color: var(--bs-white); --bs-nav-pills-link-active-color: #ff6537ff; --bs-nav-pills-link-active-bg: var(--bs-white); background-color:#ff6537ff;">
                ...
                <li class="nav-item" role="presentation">
                    <a href="#contact" style="text-decoration:none;"><button class="nav-link rounded-5" id="contact-tab2" data-bs-toggle="tab" type="button" role="tab" aria-selected="false">Contact</button></a>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="col-md-3 text-end">';
                if(!$loggedin) {
                    ...
                    if($loggedin) {
                        echo '<button type="button" class="btn btn-primary rounded-pill m-auto" style="background-color:#ff6537ff;border-color:#ffffff"><a href="logout.php" style="text-decoration:none; color:white;">Logout</a></button>';
                    }
            echo '</div>
        </header>
    </div>';
